...
def get_quotes():
    ...
    result.append("A man who dares to waste one hour of time has not discovered the value of life. -- Charles Darwin")
    ...
    result.append("After climbing a great hill, one only finds that there are many more hills to climb. -- Nelson Mandela")
    ...
    result.append("As a well-spent day brings happy sleep, so life well used brings happy death. -- Leonardo da Vinci")
    result.append("Before you point your fingers, make sure your hands are clean. -- Bob Marley")
    result.append("Being the richest man in the cemetery doesn't matter to me... Going to bed at night saying we've done something wonderful... that's what matters to me. -- Steve Jobs")
    result.append("Change before you have to. -- Jack Welch")
    result.append("Change is the law of life. And those who look only to the past or present are certain to miss the future. -- John F. Kennedy")
    ...
    result.append("Don't spend time beating on a wall, hoping to transform it into a door. -- Coco Chanel")
    ...
    result.append("Even if I knew that tomorrow the world would go to pieces, I would still plant my apple tree. -- Martin Luther")
    ...
    result.append("Good friends, good books and a sleepy conscience: this is the ideal life. -- Mark Twain")
    ...
    result.append("I am not young enough to know everything. -- Oscar Wilde")
    ...
    result.append("If today were the last day of my life, would I want to do what I am about to do today? -- Steve Jobs")
    ...
    result.append("If you would not be forgotten as soon as you are dead, either write things worth reading or do things worth writing. -- Benjamin Franklin")
    result.append("In order to write about life, first you must live it! -- Ernest Hemingway")
    ...
    result.append("It does not matter how slowly you go so long as you do not stop. -- Coufucius")
    result.append("It is not because things are difficult that we do not dare; it is because we do not dare that they are difficult. -- Seneca the Younnger")
    ...
    result.append("It takes a long time to grow young. -- Pablo Picasso")
    ...
    result.append("It's not the years in your life that count. It's the life in your years. -- Abraham Lincoln")
    ...
    result.append("Life isn't worth living, unless it is lived for someone else. -- Albert Einstein")
    ...
    result.append("Many of life's failures are people who did not realize how close they were to success when they gave up. -- Thomas Edison")
    ...
    result.append("Part of being optimistic is keeping one's head pointed toward the sun, one's feet moving forward. -- Nelson Mandela")
    ...
    result.append("Security is mostly a superstition. It does not exist in nature, nor do the children of men as a whole experience it. Avoiding danger is no safer in the long run than outright exposure. Life is either a daring adventure, or nothing. -- Helen Keller")
    ...
    result.append("The greatest victory has been to be able to live with myself, to accept my shortcomings and those of others. -- Audrey Hepburn")
    ...
    result.append("The person who has lived the most is not the one who has lived the longest, but the one with the richest experiences. -- Jean-Jacques Rousseau")
    ...
    result.append("The sole meaning of life is to serve humanity. -- Leo Tolstoy")
    ...
    result.append("There are two tragedies in life. One is not to get your heart's desire. The other is to get it. -- George Bernard Shaw")
    ...
    result.append("There's something just as inevitable as death. And that's life. -- Charlie Chaplin")
    result.append("This is the mark of a really admirable man: steadfastness in the face of trouble. -- Ludwig van Beethoven")
    ...
    result.append("To forget one's purpose is the commonest form of stupidity. -- Friedrich Nietzsche")
    ...
    result.append("To live is to think. -- Cicero")
    ...
    result.append("Watch your thoughts, for they become words. Watch your words, for they becomes actions. Watch your actions, for they become habits. Watch your habits, for they become character. Watch your character, for it becomes your destiny. -- Margaret Thatcher")
    result.append("We are born, so to speak, twice over; born into existence, and born into life. -- Jean-Jacques Rousseau")
    ...
    result.append("What is important in life is life, and not the result of life. -- Johann Wolfgang von Goethe")
    ...
    result.append("Wise men learn more from fools than fools from the wise. -- Cato the Elder")
    result.append("Without haste, but without rest. -- Johann Wolfgang von Goethe")
    result.append("You are going to let the fear of poverty govern your life and your reward will be that you will eat, but you will not live. -- George Bernard Shaw")
    ...
    result.append("Your life would be very empty if you had nothing to regret. -- Vincent van Goph")
    return result
